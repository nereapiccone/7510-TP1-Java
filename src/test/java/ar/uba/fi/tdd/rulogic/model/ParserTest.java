...
public class ParserTest {
	...
	public void setUp() throws Exception {
		...
		ruleList.add("hijo(X,Y):-varon(X),padre(Y,X)");		
		ruleList.add("hija(X,Y):-mujer(X),padre(Y,X)");
	...
	public void getQueriesTest() throws IOException {
		Assert.assertEquals(this.knowledgeBase.getQueries(), queriesList);
	}
	
	@Test
	public void getFactstest() throws IOException {
		Assert.assertEquals(this.knowledgeBase.getFacts(), factList);
	}
	
	@Test
	public void getRulestest() throws IOException {
		Assert.assertEquals(this.knowledgeBase.getRules(), ruleList);
	}
}
